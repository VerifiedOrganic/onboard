...
func registerSkillTools(rt *serverRuntime, s *mcp.Server) {
	mcp.AddTool(s, &mcp.Tool{
		Name:        "list_skills",
		Description: "List the onboarding skills embedded in this server.",
	}, withToolLog(rt, "list_skills", func(_ context.Context, _ *mcp.CallToolRequest, _ listSkillsInput) (*mcp.CallToolResult, listSkillsOutput, error) {
		all, err := skills.List()
		if err != nil {
	...
	}, withToolLog(rt, "get_skill", func(_ context.Context, _ *mcp.CallToolRequest, in getSkillInput) (*mcp.CallToolResult, getSkillOutput, error) {
